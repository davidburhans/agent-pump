...
class VerificationConfig(BaseModel):
    ...
    build_cmd: str | None = Field(
        default=None,
        description="Command to run for building the project (e.g., 'npm run build', 'cargo build')"
    )
    ...
    skip_verification: bool = Field(
        default=False,
        description="Whether to skip the verification phase entirely"
    )
...
class ProjectDetectionResult(BaseModel):
    ...
    project_type: str | None = Field(
        default=None,
        description="Detected project type (e.g., 'npm', 'cargo', 'go', 'uv')"
    )
    build_cmd: str | None = Field(
        default=None,
        description="Suggested build command based on project type"
    )
    lint_cmd: str | None = Field(
        default=None,
        description="Suggested lint command based on project type"
    )
    test_cmd: str | None = Field(
        default=None,
        description="Suggested test command based on project type"
    )
