...
class TestWorkflowSnapshot:
    ...
    def test_get_snapshot_idle(self):
        ...
        # Machine needs transitions
        workflow_def.get_transitions.return_value = []
        workflow_def.get_states.return_value = ["idle", "planning", "completed", "error"]
        workflow_def.get_phase.return_value = phase1
